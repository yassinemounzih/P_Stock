                                ...
                                <form action="{{ route('demande.store') }}" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="type" class="form-control" id="name" placeholder="Type De Colis">
                                        </div>

                                        <div class="form-group">
                                            <label for="name">Number De Colis</label>
                                            <input type="number" name="nbr" class="form-control" id="name" placeholder="Number De Colis">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Reference De Colis Exemple(1-10)</label>
                                            <input type="text" name="ref" class="form-control" id="name" placeholder="Reference De Colis Exemple(1-10)">
                                        </div>

                                        <div class="form-group">
                                            <label for="description">Adress</label>
                                            <textarea name="adress" id="description" placeholder="Enter description" class="form-control" rows="4"></textarea>
                                          </div>
